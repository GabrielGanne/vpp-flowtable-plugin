...
typedef struct {
    ...
    u16 number;
} __attribute__ ((packed)) expiration_msg_hdr_t;
...
typedef struct {
    ...
    /* pointer flowtable node used to get expiration infos */
    void * ftm;
...
extern vlib_node_registration_t pm_hit_node;
